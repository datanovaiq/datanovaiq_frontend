      ...
      <div className="max-w-[1000px] mx-auto px-6 sm:px-10 lg:px-16 xl:px-24">
        ...
        <div className="space-y-6 text-muted-foreground leading-relaxed text-lg [&>h2]:text-3xl [&>h2]:font-display [&>h2]:font-bold [&>h2]:text-foreground [&>h2]:mt-16 [&>h2]:mb-6 [&>h3]:text-2xl [&>h3]:font-display [&>h3]:font-semibold [&>h3]:text-foreground [&>h3]:mt-10 [&>h3]:mb-4 [&>h4]:text-xl [&>h4]:font-display [&>h4]:font-medium [&>h4]:text-foreground [&>h4]:mt-8 [&>h4]:mb-3 [&>ul]:list-disc [&>ul]:pl-6 [&>ul]:space-y-3 [&_strong]:text-foreground [&_strong]:font-semibold [&_a]:text-primary [&_a]:underline hover:[&_a]:text-primary/80 transition-colors">
          ...
          <ul>
            ...
            <li><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Privacy Policy) refers to datanovaiq, 525 Market St, San Francisco, CA 94105, USA.</li>
          ...
          <ul className="space-y-6">
            <li className="bg-card p-6 rounded-2xl border border-border/50">
              <strong className="text-lg block mb-3 text-foreground">Necessary / Essential Cookies</strong>
              <div className="space-y-2 text-[15px]">
                <p><span className="font-semibold">Type:</span> Session Cookies</p>
                <p><span className="font-semibold">Administered by:</span> Us</p>
            ...
            <li className="bg-card p-6 rounded-2xl border border-border/50">
              <strong className="text-lg block mb-3 text-foreground">Cookies Policy / Notice Acceptance Cookies</strong>
              <div className="space-y-2 text-[15px]">
                <p><span className="font-semibold">Type:</span> Persistent Cookies</p>
                <p><span className="font-semibold">Administered by:</span> Us</p>
                <p><span className="font-semibold">Purpose:</span> These Cookies identify if users have accepted the use of cookies on the Website.</p>
              </div>
            </li>
            <li className="bg-card p-6 rounded-2xl border border-border/50">
              <strong className="text-lg block mb-3 text-foreground">Functionality Cookies</strong>
              <div className="space-y-2 text-[15px]">
                <p><span className="font-semibold">Type:</span> Persistent Cookies</p>
                <p><span className="font-semibold">Administered by:</span> Us</p>
