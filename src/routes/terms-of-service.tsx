...
function TermsOfServicePage() {
  return (
    <div className="pt-32 pb-24 min-h-screen bg-surface">
      <div className="max-w-[1000px] mx-auto px-6 sm:px-10 lg:px-16 xl:px-24">
        ...
        <p className="text-muted-foreground font-medium mb-12 border-b border-border/50 pb-8">Last updated: June 22, 2026</p>

        <div className="space-y-6 text-muted-foreground leading-relaxed text-lg [&>h2]:text-3xl [&>h2]:font-display [&>h2]:font-bold [&>h2]:text-foreground [&>h2]:mt-16 [&>h2]:mb-6 [&>h3]:text-2xl [&>h3]:font-display [&>h3]:font-semibold [&>h3]:text-foreground [&>h3]:mt-10 [&>h3]:mb-4 [&>h4]:text-xl [&>h4]:font-display [&>h4]:font-medium [&>h4]:text-foreground [&>h4]:mt-8 [&>h4]:mb-3 [&>ul]:list-disc [&>ul]:pl-6 [&>ul]:space-y-3 [&_strong]:text-foreground [&_strong]:font-semibold [&_a]:text-primary [&_a]:underline hover:[&_a]:text-primary/80 transition-colors">
          ...
          <ul>
            ...
            <li><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in these Terms and Conditions) refers to datanovaiq, 525 Market St, San Francisco, CA 94105, USA.</li>
            ...
            <li><strong>Website</strong> refers to datanovaiq, accessible from <a href="https://datanovaiq.com/" rel="external nofollow noopener noreferrer" target="_blank">https://datanovaiq.com/</a></li>
          ...
          <ul>
            <li>By email: <a href="mailto:contact@datanovaiq.com">contact@datanovaiq.com</a></li>
            <li>By phone: <a href="tel:+14156904538">+1 (415) 690-4538</a></li>
          </ul>
        </div>
      </div>
    </div>
